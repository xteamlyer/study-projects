    ...
    public partial class AddModer : Form
    {
        ...
        private void AddBtn_click(object sender, EventArgs e)
        {
            ...
            string addQuery = selectedImageBytes != null
                ? "INSERT INTO Moderators(FullName, Gender, Email, DateOfBirth, CountryCode, PhoneNumber, Direction, EventName, Password, Photo) VALUES (@fullname, @gender, @email, @dateofbirth, @countrycode, @phonenumber, @direction, @eventname, @password, @photo)"
                : "INSERT INTO Moderators(FullName, Gender, Email, DateOfBirth, CountryCode, PhoneNumber, Direction, EventName, Password) VALUES (@fullname, @gender, @email, @dateofbirth, @countrycode, @phonenumber, @direction, @eventname, @password)";
            using (MySqlCommand command = new MySqlCommand(addQuery, database.GetConnection()))
            {
                ...
                _ = command.Parameters.AddWithValue("@eventname", eventname);
