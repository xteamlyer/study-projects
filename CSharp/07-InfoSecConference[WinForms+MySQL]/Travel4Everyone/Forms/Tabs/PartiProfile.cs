...
{
    public partial class PartiProfile : UserControl
    {
        private readonly DataBase database = new DataBase();
        private readonly string FullName; // FullName текущего жюри

        public PartiProfile(string FullName)
        {
            InitializeComponent();
        ...
        {
            string query = "SELECT ID, FullName, Gender, Email, DateOfBirth, CountryCode, PhoneNumber, Password, Photo FROM Participants WHERE FullName = @FullName";
        ...
        {
            string updateQuery = @"UPDATE Participants SET Gender = @Gender, Email = @Email, DateOfBirth = @DateOfBirth, CountryCode = @CountryCode, PhoneNumber = @PhoneNumber, Password = @Password WHERE FullName = @FullName";
        ...
        private void ChangePhoto()
        {
            using (OpenFileDialog openFileDialog = new OpenFileDialog())
            {
                ...
                if (openFileDialog.ShowDialog() == DialogResult.OK)
                {
                    ...
                    string updatePhotoQuery = "UPDATE Participants SET Photo = @Photo WHERE FullName = @FullName";
