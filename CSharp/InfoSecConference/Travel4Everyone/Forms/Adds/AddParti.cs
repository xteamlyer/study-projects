...
{
    public partial class AddParti : Form
    {
        ...
        private void AddBtn_click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(fullname) || string.IsNullOrEmpty(gender) || string.IsNullOrEmpty(email) || string.IsNullOrEmpty(dateofbirth) || string.IsNullOrEmpty(countrycode) || string.IsNullOrEmpty(phonenumber) || string.IsNullOrEmpty(dateofbirth) || string.IsNullOrEmpty(password))
            {
            ...
            string addQuery = selectedImageBytes != null
                ? "INSERT INTO Participants(FullName, Gender, Email, DateOfBirth, CountryCode, PhoneNumber, Password, Photo) VALUES (@fullname, @gender, @email, @dateofbirth, @countrycode, @phonenumber, @password, @photo)"
                : "INSERT INTO Participants(FullName, Gender, Email, DateOfBirth, CountryCode, PhoneNumber, Password) VALUES (@fullname, @gender, @email, @dateofbirth, @countrycode, @phonenumber, @password)";
