...
{
    public partial class JuryActivities : UserControl
    {
        private readonly DataBase database = new DataBase();
        public JuryActivities()
        {
            InitializeComponent();
        }
        ...
        {
            dgw.Rows.Clear();
            string querystring = $"SELECT * FROM Activities WHERE Jury1 = @CurrentUserName OR Jury2 = @CurrentUserName OR Jury3 = @CurrentUserName OR Jury4 = @CurrentUserName OR Jury5 = @CurrentUserName";
