...
{
    public partial class OrgProfile : UserControl
    {
        private readonly DataBase database = new DataBase();
        private readonly string FullName; // FullName текущего жюри

        public OrgProfile(string FullName)
        {
            InitializeComponent();
        ...
        {
            string query = "SELECT ID, FullName, Gender, Email, DateOfBirth, CountryCode, PhoneNumber, Password, Photo FROM Organizers WHERE FullName = @FullName";
        ...
        {
            string updateQuery = @"UPDATE Organizers SET Gender = @Gender, Email = @Email, DateOfBirth = @DateOfBirth, CountryCode = @CountryCode, PhoneNumber = @PhoneNumber, Password = @Password WHERE FullName = @FullName";
        ...
        private void ChangePhoto()
        {
            using (OpenFileDialog openFileDialog = new OpenFileDialog())
            {
                ...
                if (openFileDialog.ShowDialog() == DialogResult.OK)
                {
                    ...
                    string updatePhotoQuery = "UPDATE Organizers SET Photo = @Photo WHERE FullName = @FullName";
