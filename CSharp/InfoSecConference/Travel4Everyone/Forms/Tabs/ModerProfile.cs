...
{
    public partial class ModerProfile : UserControl
    {
        private readonly DataBase database = new DataBase();
        private readonly string FullName; // FullName текущего жюри

        public ModerProfile(string FullName)
        {
            InitializeComponent();
        ...
        private void LoadModerData()
        {
            string query = "SELECT ID, FullName, Gender, Email, DateOfBirth, CountryCode, PhoneNumber, Direction, EventName, Password, Photo FROM Moderators WHERE FullName = @FullName";
        ...
        {
            string updateQuery = @"UPDATE Moderators SET Gender = @Gender, Email = @Email, DateOfBirth = @DateOfBirth, CountryCode = @CountryCode, PhoneNumber = @PhoneNumber, Direction = @Direction, EventName = @EventName, Password = @Password WHERE FullName = @FullName";
            ...
            using (MySqlCommand command = new MySqlCommand(updateQuery, database.GetConnection()))
            {
                ...
                _ = command.Parameters.AddWithValue("@EventName", txtEventName.Text);
        ...
        private void ChangePhoto()
        {
            using (OpenFileDialog openFileDialog = new OpenFileDialog())
            {
                ...
                if (openFileDialog.ShowDialog() == DialogResult.OK)
                {
                    ...
                    string updatePhotoQuery = "UPDATE Moderators SET Photo = @Photo WHERE FullName = @FullName";
